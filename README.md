...
![Alt Text](https://media.giphy.com/media/fnKknfAt3kzIkynQNd/giphy.gif)
...
![Alt Text](https://media.giphy.com/media/xT5LMGAap52AK1RecU/giphy.gif)

For many incumbent operators, retaining high profitable customers is the number one business goal.

![Alt Text](https://media.giphy.com/media/5zskjtE81N1FkYEv6M/giphy.gif)
...
![Alt Text](https://media.giphy.com/media/xp4VN7OJ5hR1UadiaM/giphy.gif)
...
![Alt Text](https://media.giphy.com/media/f1Z3i47LIAHII/giphy.gif)

The ‘action’ phase: The customer experience starts to sore in this phase, for e.g. he/she gets a compelling offer from a  competitor, faces unjust charges, becomes unhappy with service quality etc. In this phase, the customer usually shows different behaviour than the ‘good’ months. Also, it is crucial to identify high-churn-risk customers in this phase, since some corrective actions can be taken at this point (such as matching the competitor’s offer/improving the service quality etc.)
![Alt Text](https://media.giphy.com/media/dW6Y1STahxMBgJlgCe/giphy.gif)

The ‘churn’ phase: In this phase, the customer is said to have churned. You define churn based on this phase. Also, it is important to note that at the time of prediction (i.e. the action months), this data is not available to you for prediction. Thus, after tagging churn as 1/0 based on this phase, you discard all data corresponding to this phase.
![Alt Text](https://media.giphy.com/media/XJGv3zjf9hOfK/giphy.gif)
